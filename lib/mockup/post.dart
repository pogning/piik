...
List<PostData> postList = [
  ...
  PostData(
    name: "@gang.name",
    title: "The Hidden Alley Scenery of Seoul",
    collected: 93,
    qualified: true,
    post:
        "The most famous place is Bukchon Hanok Village next to Gyeongbokgung Palace, which was a palace during the Joseon Dynasty...",
    category: "travel",
    imageurl: "assets/images/lens.png",
  ),
  PostData(
